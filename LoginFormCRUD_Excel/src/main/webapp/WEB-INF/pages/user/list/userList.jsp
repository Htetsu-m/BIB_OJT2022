    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <a href="${pageContext.request.contextPath}/downloadToExcel"
            class="btn btn-secondary">Download To Excel</a>
        </div>
        <h2>File Upload & Data Save Page</h2>

        <form action="${pageContext.request.contextPath}/saveExcelData"
          method="POST" enctype="multipart/form-data">
          <br /> <br /> Please select a file to upload : <input
            type="file" name="file" value="Browse File" /> <br /> <br />
          Press here to upload the file : <input type="submit"
            value="upload" /> <br /> <br />
        </form>
      </div>
    </div>
